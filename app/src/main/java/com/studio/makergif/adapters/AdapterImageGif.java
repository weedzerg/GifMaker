...
public class AdapterImageGif extends BaseAdapter {
    private ArrayList<InfoImage> ls;
    private LayoutInflater inflater;

    public AdapterImageGif(ArrayList<InfoImage> ls, LayoutInflater inflater) {
        this.ls = ls;
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        tv_nameFile.setVisibility(View.VISIBLE);
